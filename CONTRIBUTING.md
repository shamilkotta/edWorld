...
1. Firstly, [fork our repo](https://github.com/shamilkotta/edWorld/fork) by clicking the fork button on top right corner.
2. Clone that forked repo to your local system

```bash
git clone https://github.com/<your-github-username>/edWorld.git
```
...
**In order to discuss changes, you are welcome to [open an issue](https://github.com/shamilkotta/edWorld/issues/new) about what you would like to contribute. Enhancements are always encouraged and appreciated.**
